...
get_ipython().system('jupyter nbconvert --to script Digits.ipynb')
...
class Digits_Data:
    ...
    def __init__(self, relative_path='C:/Users/gigi-/keio2019aia/data/assignment1', data_file_name='digits_data.pkl'):
